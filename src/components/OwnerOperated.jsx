...
import { ownerFeatures } from "../data/site.js";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-warmgray">
            This is not a large remodeling company where a salesperson books the
            job and then sends out a rotating crew. The owner is directly
